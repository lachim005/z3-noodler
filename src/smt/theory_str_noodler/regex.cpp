            ...
            auto get_next_transducer = [&mata_alph,&backward_iterator,&backward_iterator_end]() {
                ...
                if (backward_iterator != backward_iterator_old) {
                    ...
                    mata::nft::Nft result = std::holds_alternative<zstring>(find) ?
                                                mata::strings::replace::replace_reluctant_literal(util::get_mata_word_zstring(std::get<zstring>(find)), util::get_mata_word_zstring(replace), mata_alph)
                                              : mata::strings::replace::replace_reluctant_regex(std::get<mata::nfa::Nfa>(find), util::get_mata_word_zstring(replace), mata_alph);
                    ++backward_iterator;
