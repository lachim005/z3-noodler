...
Z3-Noodler is based on the SMT solver [Z3 v4.16.0](https://github.com/Z3Prover/z3/releases/tag/z3-4.16.0), in which it replaces the solver for the theory of strings. 
