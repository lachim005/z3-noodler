...
namespace smt::noodler {
    ...
    std::vector<Predicate> DecisionProcedure::replace_disequality(Predicate diseq) {
        ...
        auto create_to_code_ineq = [this](const BasicTerm& var1, const BasicTerm& var2) {
                ...
                BasicTerm var1_to_code = BasicTerm(BasicTermType::Variable, var1.get_name().encode() + util::FRESH_VAR_DELIMITER + "ineq_to_code");
                BasicTerm var2_to_code = BasicTerm(BasicTermType::Variable, var2.get_name().encode() + util::FRESH_VAR_DELIMITER + "ineq_to_code");
