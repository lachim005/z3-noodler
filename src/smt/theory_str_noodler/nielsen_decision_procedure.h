...
namespace smt::noodler {
    ...
    protected:
         ...
         * @param arith_model Assignment of LIA variables
         */
        void generate_submodel(const ModelGenerator& generator, const std::map<BasicTerm,rational>& arith_model);
    ...
    public:
         ...
         * 
         * @param arith_model LIA assignment.
         */
